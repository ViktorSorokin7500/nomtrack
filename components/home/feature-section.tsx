...
const features = [
  ...
  },
  {
    ...
    description:
      "Whether you're aiming to lose weight, gain muscle, or just eat healthier, NomTrack keeps you on track.",
    ...
    <section className="bg-orange-50 py-16 md:py-24">
      <div className="container mx-auto px-4">
        ...
        <p className="text-gray-600 text-center max-w-2xl mx-auto mb-16">
          NomTrack combines powerful tracking with AI assistance to help you

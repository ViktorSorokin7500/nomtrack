...
export const HOME_TEXTS = {
  ...
  CTA_SECTION: {
    ...
    DESCRIPTION1: "Таблетки усувають апетит, але не вчать самоконтролю.",
    DESCRIPTION2:
      "Справжня трансформація — це не лише 'мінус 10 кг', а перебудова гормонів, звичок та мислення.",
    DESCRIPTION3:
      "NomTrack створений, щоб дати вам усвідомленість та дисципліну, які необхідні, щоб ваше тіло не повернулося до вихідного стану.",
